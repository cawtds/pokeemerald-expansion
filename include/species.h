...
static inline u32 SanitizeSpeciesId(enum Species speciesId)
{
...
static inline u16 GetSpeciesHeight(u16 species)
{
    return gSpeciesInfo[SanitizeSpeciesId(species)].height;
}

static inline u16 GetSpeciesWeight(u16 species)
{

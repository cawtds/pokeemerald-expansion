...
static u8 CreatePokedexAreaMarkers(u16 species, u16 tilesTag, u8 palIdx, u8 y);
static u8 GetUnlockedSeviiAreas(void);
static void DestroyPokedexAreaMarkers(u8 taskId);
static u8 GetNumPokedexAreaMarkers(u8 taskId);
static s32 GetSpeciesPokedexAreaMarkers(u16 species, struct Subsprite * subsprites);
...
const u32 sCategoryMonInfoBgTiles[] = INCBIN_U32("graphics/pokedex/frlg/mini_page.4bpp.lz");
const u32 sKantoDexTiles[] = INCBIN_U32("graphics/pokedex/frlg/kanto_dex_bgtiles.4bpp.lz");
const u32 sNatDexTiles[] = INCBIN_U32("graphics/pokedex/frlg/national_dex_bgtiles.4bpp.lz");
const u16 sKantoDexPalette[0x100] = INCBIN_U16("graphics/pokedex/frlg/kanto_dex_bgpals.gbapal");
...
const u16 sNationalDexPalette[0x100] = INCBIN_U16("graphics/pokedex/frlg/national_dex_bgpals.gbapal");
const u32 sTopMenuIconTiles_Cave[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_cave.4bpp.lz");
const u32 sTopMenuIconTiles_Urban[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_urban.4bpp.lz");
const u32 sTopMenuSelectionIconTiles_Cancel[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_cancel.4bpp.lz");
const u32 sTopMenuIconTiles_Forest[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_forest.4bpp.lz");
const u32 sTopMenuIconTiles_Grassland[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_grassland.4bpp.lz");
const u32 sTopMenuIconTiles_QuestionMark[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_qmark.4bpp.lz");
const u32 sTopMenuIconTiles_Mountain[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_mountain.4bpp.lz");
const u32 sTopMenuIconTiles_Rare[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_rare.4bpp.lz");
const u32 sTopMenuIconTiles_Sea[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_sea.4bpp.lz");
const u32 sTopMenuIconTiles_Numerical[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_numerical.4bpp.lz");
const u32 sTopMenuIconTiles_RoughTerrain[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_rough_terrain.4bpp.lz");
const u32 sTopMenuIconTiles_WatersEdge[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_waters_edge.4bpp.lz");
const u32 sTopMenuIconTiles_Type[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_type.4bpp.lz");
const u32 sTopMenuIconTiles_Lightest[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_lightest.4bpp.lz");
const u32 sTopMenuIconTiles_Smallest[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_smallest.4bpp.lz");
const u16 sTopMenuIconPals_Cave[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_cave.gbapal");
const u16 sTopMenuIconPals_Urban[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_urban.gbapal");
const u16 sTopMenuSelectionIconPals_Cancel[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_cancel.gbapal");
const u16 sTopMenuIconPals_Forest[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_forest.gbapal");
const u16 sTopMenuIconPals_Grassland[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_grassland.gbapal");
const u16 sTopMenuIconPals_QuestionMark[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_qmark.gbapal");
const u16 sTopMenuIconPals_Mountain[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_mountain.gbapal");
const u16 sTopMenuIconPals_Rare[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_rare.gbapal");
const u16 sTopMenuIconPals_Sea[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_sea.gbapal");
const u16 sTopMenuIconPals_Numerical[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_numerical.gbapal");
const u16 sTopMenuIconPals_RoughTerrain[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_rough_terrain.gbapal");
const u16 sTopMenuIconPals_WatersEdge[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_waters_edge.gbapal");
const u16 sTopMenuIconPals_Type[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_type.gbapal");
const u16 sTopMenuIconPals_Lightest[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_lightest.gbapal");
const u16 sTopMenuIconPals_Smallest[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_smallest.gbapal");
const u8 sDexScreen_CaughtIcon[] = INCBIN_U8("graphics/pokedex/frlg/caught_marker.4bpp");
const u32 sTilemap_AreaMap_Kanto[] = INCBIN_U32("graphics/pokedex/frlg/map_kanto.4bpp.lz");
const u32 sTilemap_AreaMap_OneIsland[] = INCBIN_U32("graphics/pokedex/frlg/map_one_island.4bpp.lz");
const u32 sTilemap_AreaMap_TwoIsland[] = INCBIN_U32("graphics/pokedex/frlg/map_two_island.4bpp.lz");
const u32 sTilemap_AreaMap_ThreeIsland[] = INCBIN_U32("graphics/pokedex/frlg/map_three_island.4bpp.lz");
const u32 sTilemap_AreaMap_FourIsland[] = INCBIN_U32("graphics/pokedex/frlg/map_four_island.4bpp.lz");
const u32 sTilemap_AreaMap_FiveIsland[] = INCBIN_U32("graphics/pokedex/frlg/map_five_island.4bpp.lz");
const u32 sTilemap_AreaMap_SixIsland[] = INCBIN_U32("graphics/pokedex/frlg/map_six_island.4bpp.lz");
const u32 sTilemap_AreaMap_SevenIsland[] = INCBIN_U32("graphics/pokedex/frlg/map_seven_island.4bpp.lz");
const u16 sBlitTiles_WideEllipse[] = INCBIN_U16("graphics/pokedex/frlg/blit_wide_ellipse.4bpp");

static const u16 sMarkerPal[] = INCBIN_U16("graphics/pokedex/frlg/area_markers/marker.gbapal");
static const u32 sMarkerTiles[] = INCBIN_U32("graphics/pokedex/frlg/area_markers/marker.4bpp.lz");

const u16 gDexScreen_TopMenuIconPals_AtoZ[] = INCBIN_U16("graphics/pokedex/frlg/cat_icon_abc.gbapal");
const u32 gDexScreen_TopMenuIconTiles_AtoZ[] = INCBIN_U32("graphics/pokedex/frlg/cat_icon_abc.4bpp.lz");
...
extern const u16 gPokedexOrder_Type[NUM_SPECIES];
...
static const u16 sCategoryPageIconWindowBg[] = INCBIN_U16("graphics/pokedex/frlg/page_icon_tilemap.bin");
...
const u16 sPalette_Silhouette[] = INCBIN_U16("graphics/pokedex/frlg/silhouette_sprite_pal.gbapal");
...
static void DexScreen_InitGfxForNumericalOrderList(void)
{
    ...
    FillWindowPixelBuffer(1, PIXEL_FILL(15));
    DexScreen_PrintControlInfo(gText_PickOKCancel);
    CopyWindowToVram(0, COPYWIN_GFX);
    CopyWindowToVram(1, COPYWIN_GFX);
}
...
static u16 DexScreen_CountMonsInOrderedList(u8 orderIdx)
{
    ...
    case DEX_ORDER_NUMERICAL_KANTO:
        for (i = 0; i < KANTO_DEX_COUNT - 1; i++)
        {
            ...
            seen = GetSetPokedexFlag(natDexNum, FLAG_GET_SEEN);
            caught = GetSetPokedexFlag(natDexNum, FLAG_GET_CAUGHT);
            if (seen)
            {
...
{
    CreateTrainerCardMonIconSprite(species, FALSE, DexScreen_GetDefaultPersonality(species), TRUE, 0, 0, paletteOffset >> 4, windowId);
}
...
static void DexScreen_PrintMonDexNo(u8 windowId, u8 fontId, u16 species, u8 x, u8 y, bool32 allowNationalDex)
{
    ...
    {
        dexNum = NationalToKantoOrder(SpeciesToNationalPokedexNum(species));
        DexScreen_AddTextPrinterParameterized(windowId, fontId, gText_PokedexNo, x, y, 0);
...
static u16 DexScreen_GetDexCount(u8 caseId, bool8 whichDex)
{
    ...
    case 0: // Kanto
        ...
        {
            if (GetSetPokedexFlag(KantoToNationalOrder(i), caseId))
                count++;
        }
        break;
    case 1: // National
...
void DexScreen_DrawMonFootprint(u8 windowId, u16 species, u8 x, u8 y)
{
    ...
    u8 ALIGNED(4) footprint4bpp[128];
    u8 * footprint;
    ...
    for (i = 0; i < 32; i++)
    {
        ...
        for (j = 0; j < 8 / 2; j++)
        {
            ...
            if (footprintPixel & (2 << (j * 2)))
                footprintTile |= 0x10;
            footprint4bpp[tileIdx] = footprintTile;
            tileIdx++;
        }
    }
    BlitBitmapRectToWindow(windowId, footprint4bpp, 0, 0, 16, 16, x, y, 16, 16);
}
...
u8 DexScreen_DrawMonAreaPage(void)
{
    ...
    monIsCaught = GetSetPokedexFlag(SpeciesToNationalPokedexNum(species), FLAG_GET_CAUGHT);
    width = 28;
    height = 14;
    left = 0;
    top = 2;
...
static u8 DexScreen_IsPageUnlocked(u8 categoryNum, u8 pageNum)
{
    ...
    for (i = 0; i < 4; i++)
    {
        if (i < count)
        {
            ...
            if (DexScreen_CanShowMonInDex(species) && GetSetPokedexFlag(SpeciesToNationalPokedexNum(species), FLAG_GET_SEEN))
                return TRUE;
        }
    }
    return FALSE;
    ...
    for (i = 0; i < NELEMS(gDexCategories); i++)
    {
        ...
        for (j = 0; j < categoryCount; j++)
        {
            ...
            for (k = 0, posInPage = 0; k < categoryPageCount; k++)
            {
                ...
                if (DexScreen_CanShowMonInDex(dexSpecies) && GetSetPokedexFlag(SpeciesToNationalPokedexNum(dexSpecies), FLAG_GET_SEEN))
                    posInPage++;
            }
        }
    }
...
{
    u32 nationalDexNo = SpeciesToNationalPokedexNum(species);
...
static void GetAreaMarkerSubsprite(s32 i, s32 dexArea, struct Subsprite * subsprites)
{

...
static const struct ListMenuItem sTradingBoardTypes[NUMBER_OF_MON_TYPES] = {
    { gTypeInfos[TYPE_NORMAL].name,   TYPE_NORMAL         },
    { gTypeInfos[TYPE_FIRE].name,     TYPE_FIRE           },
    { gTypeInfos[TYPE_WATER].name,    TYPE_WATER          },
    { gTypeInfos[TYPE_ELECTRIC].name, TYPE_ELECTRIC       },
    { gTypeInfos[TYPE_GRASS].name,    TYPE_GRASS          },
    { gTypeInfos[TYPE_ICE].name,      TYPE_ICE            },
    { gTypeInfos[TYPE_GROUND].name,   TYPE_GROUND         },
    { gTypeInfos[TYPE_ROCK].name,     TYPE_ROCK           },
    { gTypeInfos[TYPE_FLYING].name,   TYPE_FLYING         },
    { gTypeInfos[TYPE_PSYCHIC].name,  TYPE_PSYCHIC        },
    { gTypeInfos[TYPE_FIGHTING].name, TYPE_FIGHTING       },
    { gTypeInfos[TYPE_POISON].name,   TYPE_POISON         },
    { gTypeInfos[TYPE_BUG].name,      TYPE_BUG            },
    { gTypeInfos[TYPE_GHOST].name,    TYPE_GHOST          },
    { gTypeInfos[TYPE_DRAGON].name,   TYPE_DRAGON         },
    { gTypeInfos[TYPE_STEEL].name,    TYPE_STEEL          },
    { gTypeInfos[TYPE_DARK].name,     TYPE_DARK           },

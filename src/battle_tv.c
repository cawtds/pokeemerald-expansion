...
{
    [PTS_MOVE_EFFECT]            = NULL, // gBattleMoveEffects
...
static void AddMovePoints(u8 caseId, u16 arg1, u8 arg2, u8 arg3)
{
    ...
    case PTS_MOVE_EFFECT:
        movePoints->points[atkSide][gBattlerPartyIndexes[gBattlerAttacker] * 4 + arg1] += gBattleMoveEffects[arg2].battleTvScore;
        break;
...
#define power arg2
    ...
    case PTS_REFLECT:
        ...
        if (GetTypeDamageCategory(type) == DAMAGE_CATEGORY_PHYSICAL && power != 0 && tvPtr->side[defSide].reflectMonId != 0)
        {
    ...
    case PTS_LIGHT_SCREEN:
        ...
        if (GetTypeDamageCategory(type) != DAMAGE_CATEGORY_PHYSICAL && power != 0 && tvPtr->side[defSide].lightScreenMonId != 0)
        {

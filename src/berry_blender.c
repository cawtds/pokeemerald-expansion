...
#define NUM_NPC_BERRIES BERRY_ASPEAR
...
static const u8 sOpponentBerrySets[NUM_NPC_BERRIES * 2][3] =
{
    ...
    {BERRY_ASPEAR - 1, BERRY_RAWST - 1,  BERRY_PECHA - 1},   // player chose Cheri Berry
    {BERRY_CHERI - 1,  BERRY_ASPEAR - 1, BERRY_RAWST - 1},   // player chose Chesto Berry
    {BERRY_CHESTO - 1, BERRY_CHERI - 1,  BERRY_ASPEAR - 1},  // player chose Pecha Berry
    {BERRY_PECHA - 1,  BERRY_CHESTO - 1, BERRY_CHERI - 1},   // player chose Rawst Berry
    {BERRY_RAWST - 1,  BERRY_PECHA - 1,  BERRY_CHESTO - 1},  // player chose Aspear Berry

    // These sets are used if the player chose a different berry (set is selected by player's berry % 5)
    {BERRY_CHERI - 1,  BERRY_PECHA - 1,  BERRY_RAWST - 1},   // player chose Leppa, Figy, ...
    {BERRY_CHESTO - 1, BERRY_RAWST - 1,  BERRY_ASPEAR - 1},  // player chose Oran, Wiki, ...
    {BERRY_PECHA - 1,  BERRY_ASPEAR - 1, BERRY_CHERI - 1},   // player chose Persim, Mago, ...
    {BERRY_RAWST - 1,  BERRY_CHERI - 1,  BERRY_CHESTO - 1},  // player chose Lum, Aguav, ...
    {BERRY_ASPEAR - 1, BERRY_CHESTO - 1, BERRY_PECHA - 1},   // player chose Sitrus, Iapapa, ...
};
...
{
    const struct BerryInfo *berryInfo = GetBerryInfo(Item_GetSecondaryId(itemId));

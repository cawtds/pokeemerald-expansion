...
static u8 EggHatchCreateMonSprite(u8 useAlt, u8 state, u8 partyId, u16 *speciesLoc)
{
    ...
    case 0:
        // Load mon sprite gfx
        {
            ...
            HandleLoadSpecialPokePic_DontHandleDeoxys(TRUE, gMonSpritesGfxPtr->sprites.ptr[(useAlt * 2) + B_POSITION_OPPONENT_LEFT], species, pid);
    ...
    case 1:
        // Create mon sprite
        SetMultiuseSpriteTemplateToPokemon(GetMonSpritePalTag(mon), position);

...
static void InitContestMonPixels(u16 species, bool8 backPic)
{
    ...
    if (!backPic)
    {
        HandleLoadSpecialPokePic_DontHandleDeoxys(TRUE, gMonSpritesGfxPtr->sprites.ptr[B_POSITION_OPPONENT_LEFT], species, gContestPaintingWinner->personality);
    ...
    {
        HandleLoadSpecialPokePic_DontHandleDeoxys(FALSE, gMonSpritesGfxPtr->sprites.ptr[B_POSITION_PLAYER_LEFT], species, gContestPaintingWinner->personality);
